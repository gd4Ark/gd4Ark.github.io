...
*原文地址：《[A Deep Dive Comparison Between useMemo And useCallback](https://www.chakshunyu.com/blog/a-deep-dive-comparison-between-usememo-and-usecallback/)》 | Technical Blog*

- 它们的目的：都是通过缓存提高性能，避免组件重复渲染
- 相似之处：
  - 用法一致：与所有 hooks 一样，只能在组件的底层调用
...
*原文地址：《[How You As a Junior Developer Can Immediately Provide Value When Joining a Team](https://www.chakshunyu.com/blog/how-you-as-a-junior-developer-can-immediately-provide-value-when-joining-a-team/)》 | Technical Blog*
...
- **新鲜血液：**任何一个项目组都不可能每次时刻使用最新的技术、工具，可能会使得团队成员没有动力跟上最先进的技术，陷入一种恶性循环之中。你作为一个团队的新成员，可能你反而会在当前领域了解更多最先进的技术和工具，从而打破团队的恶性循环。
- **意识到团队沟通的问题：**长期合作的团队可能面临习惯现有的沟通方式，会自动忽略对方的缺陷，导致缺乏真正的沟通。而你能够意识到这些问题，并帮助团队提高这方面的效率。
- **挑战团队现有的知识**：每个团队内部都有一些的解决方案或流程，并且习惯与此，而你可以提出更多潜在的替代方案，帮助团队寻找更优的解决方案。
...
*原文地址：《[Your Code Doesn't Have to Be Perfect](https://www.chakshunyu.com/blog/your-code-doesnt-have-to-be-perfect/)》 | Technical Blog*
...
原文地址：《[The Most Important Thing I Learned About Writing Readable Code](https://www.chakshunyu.com/blog/the-most-important-thing-i-learned-about-writing-readable-code/)》 | Technical Blog
