...
在去年《[2021 年度总结](http://localhost:4000/post/2021-summary.html)》有提到，我曾有过一段开小电动车上班的时光，通勤时间极短，幸福感倍高，但由于公司地址搬迁，就再也没有享受过这样的日子了，即便后来跳槽到新公司，通勤时间短了一半，但也要 40 分钟左右的通勤时间，所以，在租房合同到期后，我决定搬到公司附近。
...
### 我对 Svelte 的看法
*原文地址：[《我对 Svelte 的看法》 by Randy's Blog](https://lutaonan.com/blog/svelte/)*
...
### Svelte 的异步更新实现原理
*原文地址：[《Svelte 的异步更新实现原理》 by Randy's Blog](https://lutaonan.com/blog/how-svelte-set-state-works/)*
...
*原文地址：[《开发模式 "Development Mode" 是如何工作的？》 by Dan Abramov](https://overreacted.io/zh-hans/how-does-the-development-mode-work/)*
...
### 通俗易懂的代数效应
*原文地址：[《通俗易懂的代数效应》 by Dan Abramov](https://overreacted.io/zh-hans/algebraic-effects-for-the-rest-of-us/)*
...
### 防御性 CSS
*原文地址：[《防御性 CSS》 by ishadeed](https://ishadeed.com/article/defensive-css/)*
...
*原文地址：[《SSR、SSG、ISR、DPR 有什么区别？》 by 前端里](http://www.yyyweb.com/5407.html)*
...
### 不优雅的 React Hooks
*原文地址：[《不优雅的 React Hooks》 by 蚂蚁 RichLab 前端团队](https://zhuanlan.zhihu.com/p/455317250)*
...
### DevTools 实现原理
*原文地址：[《DevTools 实现原理》 by vivo 互联网浏览器内核团队](https://mp.weixin.qq.com/s/H8iahg5WUOHXeRzvf0R01w?scene=25#wechat_redirect)*
...
- [Z-Library](https://zh.z-lib.org/)：世界上最大的数字图书馆，在这里可以找到大量的电子书籍，格式包括：pdf、epub、mobi 等，对于笔者这种不爱看实体书的人来说，简直是神器。但需要注意每天一个 ip 会限制下载数量，未注册用户是 5 次，注册用户是 10 次，当然也可以通过捐赠来提高下载次数的限制。
