...
### [问 HN：你如何在网上找到可靠的信息？](https://news.ycombinator.com/item?id=31107699)
...
而获取灰度值的公式为：(0.299 \* _r_ + 0.587 \* _g_ + 0.114 \* _b_) / 255
...
### [WebAssembly 使用 JavaScript 垃圾回收器](https://jott.live/markdown/js_gc_in_wasm)
