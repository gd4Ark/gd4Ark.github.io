...
2022 年 2 月 24 号，俄罗斯入侵乌拉克，与此同时，国内的媒体出现了铺天盖地的假信息、在微博、抖音上网友们更是发表了各种极度令人恶心的言论，让我备受震撼。
...
_原文地址：[《Yes, I can connect to a DB in CSS》 | kamelåså](https://www.leemeichin.com/posts/yes-i-can-connect-to-a-db-in-css.html)_
...
_原文地址：[《Why Vim is better than VSCode》 | Sean](https://sean-warman.medium.com/why-vim-is-better-than-vscode-d09e2355eb37)_
...
作者认为相比于 VSCode，还是 Vim 更胜一筹，因为它轻巧快熟，可以在服务器上通过 SSH 写代码，所有事情都可以在终端中完成，可移植性和可配置性都非常高，并且基于 xterm.js 也可以轻松实现在浏览器上使用 Vim 进行远程开发。
...
_原文地址：[《CSS :not() 伪类选择器已支持复杂参数》 | 张鑫旭](https://www.zhangxinxu.com/wordpress/2022/02/css-not-pseudo-class-list-argument/?utm_source=tuicool&utm_medium=referral)_
...
_原文地址：[《Facebook 工程师文化独特之处》 | Cat Chen](https://chinese.catchen.me/2022/02/unique-engineering-culture-of-facebook.html)_
