...
1. **Hooks**
   ...
   4. [useSyncExternalStore](https://reactjs.org/docs/hooks-reference.html#usesyncexternalstore)：允许外部存储通过强制对存储的更新为同步来支持并发读取。
   5. [useInsertionEffect](https://reactjs.org/docs/hooks-reference.html#useinsertioneffect)：允许 CSS-in-JS 库解决在渲染中注入样式的性能问题。
...
### [我讨厌的 5 个编码面试问题](https://thoughtspile.github.io/2022/03/21/bad-tech-interview/)
