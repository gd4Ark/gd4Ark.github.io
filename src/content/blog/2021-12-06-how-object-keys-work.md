...
>
> 1.  Let _obj_ be ? [ToObject](https://tc39.es/ecma262/#sec-toobject)(_O_).
> 1.  Let _nameList_ be ? [EnumerableOwnPropertyNames](https://tc39.es/ecma262/#sec-enumerableownpropertynames)(_obj_, key).
> 1.  Return [CreateArrayFromList](https://tc39.es/ecma262/#sec-createarrayfromlist)(_nameList_).
...
1. 当对象添加、删除属性的时候，会创建一个新的对应的**隐藏类**，并重新指向它。
1. V8 有一个转换树的机制来创建隐藏类，不过本文不赘述，有兴趣可以看[这里](https://v8.dev/blog/fast-properties#hiddenclasses-and-descriptorarrays)。
