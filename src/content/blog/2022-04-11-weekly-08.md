---
title: 周刊第 8 期：阅读 ECMAScript 规范
...
此书是 Ruby 语言的创造者 —— 松本行宏在《日经 Linux》杂志上的连载整合而成，主要介绍了新语言 Streem 的设计与实现过程。作者从设计 Streem 这门新语言的动机开始讲起，由浅入深，详细介绍了新语言开发中的各个环节，以及语言设计上的纠结与取舍，其中也不乏对其他编程语言的调查与思考，向读者展示了创建编程语言的乐趣。
...
### [为什么「Enter 键」要被翻译为「回车键」？](https://haohailong.net/2012/why-enter-key-is-huiche-in-chinese)
...
- [QUOKKA](https://quokkajs.com/)：_Quokka_ 是一个调试工具，可以为您正在编写的代码提供实时反馈（可惜大部分功能都要收费。
