---
title: 周刊第 9 期：Web 发展中的 100 个重大事件
...
但遗憾的是，截止目前（2022-04-18）只有 Safari 15.4 和 Chrome Canary 支持该特性，详见 [caniuse](https://caniuse.com/css-has)。
...
>
> **Possible previous states:** > [hidden](https://developer.chrome.com/blog/page-lifecycle-api/#state-hidden) _(via the [`pagehide`](https://developer.chrome.com/blog/page-lifecycle-api/#event-pagehide) event)_
>
...
- [The WebAIM Million](https://webaim.org/projects/million/) ：2022 年关于前 100 万个主页的可访问性报告。
